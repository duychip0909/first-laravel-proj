        ...
        <div class="container d-flex align-items-center justify-content-center h-100">
            <div class="card register">
                ...
                <form action="post">
                    ...
                    <input type="text" class="d-block" placeholder="Enter your email">
                    ...
                    <a href="#" class="learnmore-btn py-2 mt-4">Sign up</a>
                </form>
                <span class="d-inline-block text-center mt-3">Already have an account? <a href="/login" class="text-info">Sign in instead</a></span>
            </div>
        </div>
    </div>
@endsection
